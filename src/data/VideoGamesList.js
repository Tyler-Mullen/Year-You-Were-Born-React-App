const VideoGames1971 = [
    {title: 'The Oregon Trail'},
    {title: 'Computer Space'}
];

const VideoGames1972 = [
    {title: 'Pong'},
    {title: 'Hunt the Wumpus'}
];

const VideoGames1973 = [
    {title: 'Space Race'},
    {title: 'Empire'}
];

const VideoGames1974 = [
    {title: 'Maze War'},
    {title: 'Gran Trak 10'},
    {title: 'Spasim'}
];

const VideoGames1975 = [
    {title: 'Gun Fight'},
    {title: 'pedit15'},
    {title: 'Shark Jaws'}
];

const VideoGames1976 = [
    {title: 'Breakout'},
    {title: 'Heavyweight Champ'},
    {title: 'Colossal Cave Adventure'}
];

const VideoGames1977 = [
    {title: 'Zork'},
    {title: 'Combat'},
    {title: 'Indy 500'}
];

const VideoGames1978 = [
    {title: 'Space Invaders'},
    {title: 'Football'},
    {title: 'Orbit'}
];

const VideoGames1979 = [
    {title: 'Asteroids'},
    {title: 'Galaxian'}
];

const VideoGames1980 = [
    {title: 'Pac-Man'},
    {title: 'Game & Watch'},
    {title: 'Space Panic'}
];

const VideoGames1981 = [
    {title: 'Donkey Kong'},
    {title: 'Defender'},
    {title: 'Frogger'},
    {title: 'Galaga'},
...
const VideoGames1983 = [
    {title: 'Dragons Lair'},
    {title: 'Star Wars'},
    {title: 'Mario Bros.'}
];

const VideoGames1984 = [
    {title: 'Tetris'},
    {title: 'Duck Hunt'},
    {title: 'Excitebike'}
];

const VideoGames1985 = [
...
const VideoGames1988 = [
    {title: 'Super Mario Bros. 3'},
    {title: 'Ninja Gaiden'},
    {title: 'Ghouls n Ghosts'}
];

const VideoGames1989 = [
    {title: 'SimCity'},
    {title: 'Final Fight'},
    {title: 'Mother'}
];

const VideoGames1990 = [
    {title: 'Super Mario World'},
    {title: 'F-Zero'},
    {title: 'The Secret of Monkey Island'}
];

const VideoGames1991 = [
...
const VideoGames1995 = [
    {title: 'Chrono Trigger'},
    {title: 'Full Throttle'},
    {title: 'Twisted Metal'}
];

const VideoGames1996 = [
...
const VideoGames2003 = [
    {title: 'Star Wars: Knights of the Old Republic'},
    {title: 'Call of Duty'},
    {title: 'The Legend of Zelda: The Windwaker'}
];

const VideoGames2004 = [
    {title: 'Half-Life 2'},
    {title: 'World of Warcraft'},
    {title: 'Fable'}
];

const VideoGames2005 = [
...
const VideoGames2014 = [
    {title: 'Bayonetta 2'},
    {title: 'Mario Kart 8'},
    {title: 'Hearthstone'},
    {title: 'Destiny'},
    {title: 'Lord of the Rings: Shadow of Mordor'}
];

const VideoGames2015 = [
    {title: 'Bloodbourne'},
    {title: 'Undertale'},
    {title: 'Rocket League'},
...
const VideoGames2016 = [
    {title: 'Overwatch'},
    {title: 'Battlefield 1'},
    {title: 'Stardew Valley'},
    {title: 'Final Fantasy VX'}
];

const VideoGames2017 = [
